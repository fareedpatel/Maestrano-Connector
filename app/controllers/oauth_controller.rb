class OauthController < ApplicationController
  def request_omniauth
    if is_admin
      ...
      redirect_to client.auth_code.authorize_url(redirect_uri: "https://02280dd1.ngrok.io/auth/baseCRM/callback"), id: current_user.id
    else
  ...
  def create_omniauth
    ...
    if organization && is_admin?(current_user, organization)
      ...
      if params[:code].present?
        token = client.auth_code.get_token(params[:code], redirect_uri: "https://https://02280dd1.ngrok.io/auth/baseCRM/callback")
