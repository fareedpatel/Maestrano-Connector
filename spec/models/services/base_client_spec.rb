...
describe BaseClient do
  ...
  it "Stores URI for the callback" do
    expect(BaseClient::REDIRECT_URI).to match (/^https.+\/auth\/baseCRM\/callback/)
  end

  it "Has a method to authorize that creates an OAuth2 client" do
